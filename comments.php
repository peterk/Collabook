...
<?php thematic_abovecommentslist() ?>
				...
				<div id="comments-list" class="comments">
					<h2><?php printf($comment_count > 1 ? __(thematic_multiplecomments_text(), 'thematic') : __(thematic_singlecomment_text(), 'thematic'), $comment_count) ?></h2>
...
<?php thematic_abovetrackbackslist() ?>
				...
				<div id="trackbacks-list" class="comments">
					<h2><?php printf($ping_count > 1 ? __('<span>%d</span> Trackbacks', 'thematic') : __('<span>One</span> Trackback', 'thematic'), $ping_count) ?></h2>
...
<?php
	if ( 'open' == $post->comment_status ) : 
		if (THEMATIC_COMPATIBLE_COMMENT_FORM) {?>
				<div id="respond">
    				<h2><?php comment_form_title( __(thematic_postcomment_text(), 'thematic'), __(thematic_postreply_text(), 'thematic') ); ?></h2>
